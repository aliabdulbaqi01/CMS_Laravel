    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="category_id" class="form-select" aria-label="Default select example">
                                    <option > Choose one of the Category</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="tags" value="{{old('tags')}}" class="form-control " type="text" data-role="tagsinput">
                            </div>
                        </div>
                        <!-- end row -->
      ...
      <textarea id="elm1" name="description" class="form-control">{{old('description')}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg" src="{{ url('uploads/no_image.jpg') }}" alt="show image">
                            </div>
                        </div>
                        <!-- end row -->
